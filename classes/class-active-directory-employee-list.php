...
if( !class_exists( 'active_directory_employee_list' ) ) {
	...
	class active_directory_employee_list {
		...
		function __construct() {
			...
			wp_register_script( 'ad-employee-list-admin', plugins_url( 'js/active-directory-employee-list.admin.js', dirname( __FILE__ ) ), array( 'jquery', 'post' ), '0.2a', true );
			wp_register_style( 'ad-employee-list-admin-style', plugins_url( 'css/active-directory-employee-list.admin.css', dirname( __FILE__ ) ), array( 'widgets' ), '0.2a', 'all' );
		}
